    ...
    <div class="mui-card">
      ...
      <div class="mui-card-content">
        <div class="mui-card-content-inner">
          ...
          <p class="number">
            <span>购买数量:</span>
            <numbox @getcount="getSelectedCount" :max="goodinfo.stock_quantity"></numbox>
          </p>
          <p>
...
export default {
  data() {
    return {
      id: this.$route.params.id, //将路由对象中id挂载到data中去,方便以后调用
      lunbotu: [],
      goodinfo: {},
